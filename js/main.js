...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "I am Ksandros, a Cybersecurity student and enthusiast. You have reached my terminal, \n good to see you here :). Currently, I am working towards the completion of my master's \n at ETH Zurich and EPF Lausanne, with my thesis at hand. \n \n In this shell you can find mostly everything about me. \n \n The 'help' command  will give you instructions on all commands you can execute here. \n",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        "Curriculum_Vitae.txt": "https://./CV_KAP.pdf",
        "LinkedIn.txt": "https://ch.linkedin.com/in/kapostoli",
        "twitter.txt": "https://twitter.com/ksei__  ",
        "about_This_Shell.txt": "While I added my own features to it, I am not the creator of this terminal, but...\nThis website was made using only pure JavaScript with no extra libraries.\n If you like it, make sure to give your kudos to: luisbraganca@protonmail.com. \n If you want to use it, you can find it available on GitHub. \n If you manage to find any bugs or security issues please use the same email as above. "
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
